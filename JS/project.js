...
// Function that pluralizes the object value 
		...
		return "Your donation of $" + donation + " helps fund " + donation_to_cookstove + " of a clean cookstove to a family, and is the equivalent of " + donationDividedByObjVal +  " " + pluralKey;		
	}
